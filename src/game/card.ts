...
export const mockCard: Card = [
  ...
  /* ---------- Like Numbers ---------- */
  {
    ...
    label: 'FFFF NNNN NNNN NN',
    description: 'Any like number, any 3 suits',
    points: 25,
    concealed: false,
    jokersAllowed: true,
    suitCount: 3,
  ...
  },
  {
    id: 'EV-2',
    section: '2468',
    label: 'FFFF EEEE EEEE EE',
    description: 'Any like even number, any 3 suits',
    points: 25,
    concealed: false,
    jokersAllowed: true,
    suitCount: 3,
  ...
  /* ---------- 369 ---------- */
  {
    id: 'NN-1',
    section: '369',
    label: 'FF 333 666 999 GGG',
    description: 'Any 1 suit, Green Dragon',
    points: 30,
    concealed: false,
    jokersAllowed: true,
    suitCount: 1,
  ...
  /* ---------- Consecutive Run ---------- */
  {
    ...
    label: 'NN OOO PPP QQQ RRR',
    description: 'Five consecutive numbers, any 1 suit',
    points: 30,
    concealed: false,
    jokersAllowed: true,
    suitCount: 1,
  ...
  /* ---------- Winds & Dragons ---------- */
  {
    ...
    label: 'N E W S RRRR GGGG DD',
    description: 'Red kong, Green kong, Soap pair',
    points: 30,
    concealed: false,
    jokersAllowed: true,
    suitCount: 1,
  ...
  /* ---------- Quints ---------- */
  {
    id: 'QN-1',
    section: 'Quints',
    label: 'FFFF NNNNN NNNNN',
    description: 'Two quints of one number (needs jokers), any 2 suits',
    points: 40,
    concealed: false,
    jokersAllowed: true,
    suitCount: 2,
  ...
  /* ---------- Singles & Pairs (concealed) ---------- */
  {
    ...
    description: 'Seven consecutive pairs, any 1 suit — concealed',
    points: 50,
    concealed: true,
    jokersAllowed: false,
    suitCount: 1,
